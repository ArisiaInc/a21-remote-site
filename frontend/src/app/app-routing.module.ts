...
import { VideoComponent as VideoGameComponent } from './gaming/video/video.component';
import { TabletopComponent } from './gaming/tabletop/tabletop.component';
import { LarpComponent } from './gaming/larp/larp.component';
import { SpecialComponent as GamingSpecialEventsComponent } from './gaming/special/special.component';
...
const routes: Routes = [
  ...
  {path: 'gaming/video', component: VideoGameComponent, canActivate: [AuthGuard]},
  ...
  {path: 'gaming/special', component: GamingSpecialEventsComponent, canActivate: [AuthGuard]},
